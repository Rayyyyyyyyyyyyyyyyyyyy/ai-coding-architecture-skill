...
The nearest document may add local specificity, but it must not silently contradict higher-level rules. Read only documents relevant to the active boundary.
