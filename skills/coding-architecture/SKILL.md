...
description: Guide maintainable frontend architecture when implementing or refactoring UI components, hooks/composables, state, design-system usage, or frontend data boundaries. Use it to choose reuse, composition, extraction, and justified abstractions while preserving repository conventions. Do not use for backend-only architecture or trivial cosmetic edits.
---
