...
- **Diagnosis:** identify the violated safety boundary; invoke `debug-with-evidence` only when causal investigation is required. Do not fix unless requested.
