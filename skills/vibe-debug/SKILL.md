...
After a fix, invoke `vibe-verify`. Report cause, decisive evidence, fix if authorized, and remaining uncertainty. On actual agent transfer invoke `vibe-handoff`.
